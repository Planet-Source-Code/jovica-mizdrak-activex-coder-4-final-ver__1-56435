...
Public Function generate(name As String, typ As String, variable As String) As String
    If typ = "StdPicture" Then
    generate = "Public Property " & "Let " & name & "(temp as " & typ & ")" & vbNewLine & vbTab & "Set " & variable & " = " & "temp" & vbNewLine & vbTab & "PropertyChanged " & """" & name & """" & vbNewLine & vbTab & "UserControl_Paint" & vbNewLine & "End Property"
    generate = generate & vbNewLine & vbNewLine & "Public Property " & "Get " & name & "() as " & typ & vbNewLine & vbTab & "Set " & name & " = " & variable & vbNewLine & "End Property" & vbNewLine & vbNewLine
    generate = generate & "Public Property " & "Set " & name & "(temp as " & typ & ")" & vbNewLine & vbTab & "Set " & variable & " = " & "temp" & vbNewLine & vbTab & "PropertyChanged " & """" & name & """" & vbNewLine & "End Property"
        Else
    generate = "Public Property " & "Let " & name & "(temp as " & typ & ")" & vbNewLine & vbTab & variable & " = " & "temp" & vbNewLine & "End Property"
    generate = generate & vbNewLine & vbNewLine & "Public Property " & "Get " & name & "() as " & typ & vbNewLine & vbTab & name & " = " & variable & vbNewLine & "End Property"
    End If
End Function
...
Function Get_After_Comma(ByVal intCommaNumber As Integer, ByVal strString As String) As String
    ...
    Else
        ...
        'place start of string after intCommaNum
        '     ber-th comma (-1 since
        'already did one
        boolNotFound = 0
